  ...
  try {
    ...
    const productsData = [
      ...
      },
      {
        ...
        images: JSON.stringify(["https://placehold.co/600x600/1e293b/ffffff?text=Ryzen+7800X3D"]), isFeatured: true, isNew: false, isOnSale: true, warranty: "3 Years"
      },
      ...
      {
        name: "ASUS ROG Strix RTX 4080 Super", slug: "asus-rog-rtx-4080-super",
        description: "16GB GDDR6X, DLSS 3, Triple fan cooling. Ultimate 4K gaming performance.",
        shortDesc: "16GB 4K Gaming Beast",
        price: 395000, originalPrice: 420000, stock: 3, sku: "ASU-4080S-16G",
        categoryId: findCat("graphics-cards"), brandId: findBrand("asus"),
        specs: JSON.stringify({ "VRAM": "16 GB GDDR6X", "Memory Bus": "256-bit", "Boost Clock": "2670 MHz", "CUDA Cores": "10240", TDP: "320W", "Outputs": "3x DP 1.4a, 2x HDMI 2.1" }),
        images: JSON.stringify(["https://placehold.co/600x600/1e293b/ffffff?text=RTX+4080+Super"]), isFeatured: true, isNew: true, isOnSale: true, warranty: "3 Years"
      },
      {
      ...
      },
      {
        ...
        images: JSON.stringify(["/images/products/asus-z790-hero.webp"]), isFeatured: true, isNew: true, isOnSale: false, warranty: "3 Years"
      },
    ...
    const faqsData = [
      ...
      // Repair & Services
      { question: "What repair services do you offer?", answer: "We offer comprehensive repair services including: laptop screen replacement, motherboard repair, OS installation, and hardware upgrades for desktops/laptops.", category: "Repair & Services", order: 10, isActive: true },
      { question: "How long do repairs usually take?", answer: "Simple repairs like OS installation can be completed same day. Hardware repairs typically take 1-3 business days depending on parts availability.", category: "Repair & Services", order: 11, isActive: true },
      { question: "Do you provide repair warranties?", answer: "Yes, all repair services come with a service warranty. Typically 30 days for software and 90 days for hardware repairs.", category: "Repair & Services", order: 12, isActive: true },
      { question: "Can you build a custom PC for me?", answer: "Absolutely! Custom PC building is our specialty. Use our online PC Builder tool or visit our store and our experts will help you design your dream build.", category: "Repair & Services", order: 13, isActive: true },
      
      // CCTV & Security
      { question: "What CCTV brands do you carry?", answer: "We are an authorized dealer for Tiandy CCTV products, offering a range of cameras, NVRs, and accessories.", category: "CCTV & Security", order: 14, isActive: true },
      { question: "Do you provide CCTV installation services?", answer: "Yes! We provide complete CCTV installation services including site survey, cabling, installation, and configuration for homes and businesses.", category: "CCTV & Security", order: 15, isActive: true },
      { question: "Can I view my CCTV cameras remotely on my phone?", answer: "Yes! All our Tiandy CCTV systems support remote viewing via smartphone apps from anywhere in the world with an internet connection.", category: "CCTV & Security", order: 16, isActive: true },
    ];
