...
export async function POST() {
  try {
    ...
    const categories: { id: string; slug: string; [key: string]: unknown }[] = [];
    ...
    const brands: { id: string; slug: string; [key: string]: unknown }[] = [];
    ...
    // Create all products
    const createdProducts: { id: string; [key: string]: unknown }[] = [];
