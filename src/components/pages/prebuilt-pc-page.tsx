  ...
  return (
    <div className="min-h-screen">
      <PageHero 
        ...
        badges={[
          { icon: <Check className="w-4 h-4 text-blue-300" />, text: "Tested & Verified" },
          { icon: <Zap className="w-4 h-4 text-amber-300" />, text: "High Performance" },
          { icon: <Shield className="w-4 h-4 text-emerald-300" />, text: "1-3 Year Warranty" },
        ]}
      />
